...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Article.preview_image_small'
        db.delete_column(u'notes_article', 'preview_image_small')


        # Changing field 'Article.preview_image'
        db.alter_column(u'notes_article', 'preview_image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

    def backwards(self, orm):
        # Adding field 'Article.preview_image_small'
        db.add_column(u'notes_article', 'preview_image_small',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Article.preview_image'
        db.alter_column(u'notes_article', 'preview_image', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
    ...
    models = {
        ...
        u'notes.article': {
            ...
            'preview_image': ('django.db.models.fields.files.ImageField', [], {'default': 'None', 'max_length': '100', 'null': 'True', 'blank': 'True'}),
