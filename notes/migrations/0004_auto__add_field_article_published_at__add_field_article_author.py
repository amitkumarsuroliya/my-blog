...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'notes_article', 'published_at')

        # Deleting field 'Article.author'
        db.delete_column(u'notes_article', 'author_id')
