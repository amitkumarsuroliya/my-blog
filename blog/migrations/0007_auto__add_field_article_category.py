...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'blog_article', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['blog.Category'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.category'
        db.delete_column(u'blog_article', 'category_id')
